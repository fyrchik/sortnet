...
//go:generate go run ../main.go -n 4 -out networks/pairwise4.go -sort pairwise -name Pairwise4
...
//go:generate go run ../main.go -n 8 -out networks/pairwise8.go -sort pairwise -name Pairwise8
...
//go:generate go run ../main.go -n 16 -out networks/pairwise16.go -sort pairwise -name Pairwise16
